...
with tf.compat.v1.variable_scope('layer_1'):
    weights = tf.compat.v1.get_variable("weights1", shape=[number_of_inputs, layer_1_nodes],
...
with tf.compat.v1.variable_scope('layer_3'):
    weights = tf.compat.v1.get_variable("weights3", shape=[layer_2_nodes, layer_3_nodes],
                                        initializer=tf.compat.v1.keras.initializers.glorot_normal())
...
with tf.compat.v1.variable_scope('output'):
    weights = tf.compat.v1.get_variable("weights4", shape=[layer_3_nodes, number_of_outputs],
                                        initializer=tf.compat.v1.keras.initializers.glorot_normal())
